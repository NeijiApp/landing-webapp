/**
 * @fileoverview Page Ask - Interface de chat IA pour les utilisateurs authentifiés
 * 
 ...
 * - Validation d'email pour utilisateurs non authentifiés
 * - Limitation du nombre de messages pour utilisateurs non inscrits
 * 
 * @author Neiji Team
 * @version 1.0.0
 * @since 2025
