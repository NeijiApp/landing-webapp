...
import { Ban, type LucideIcon, SendHorizonal, Brain, Sparkles } from "lucide-react";
	...
	return (
		<>
			...
			<div className={cn(
				...
				</div>				<div className="bg-gradient-to-r from-white/90 to-orange-100/90 p-4 backdrop-blur-md rounded-t-2xl">					<div className="flex items-center gap-3">
						<ChatModeButton
							icon={Brain}
