 ...
 */
export function CustomDrawer({ isOpen, children, className }: CustomDrawerProps) {
  return (
    <div 
      className={cn(
    ...
    >
      <div className="bg-white rounded-t-2xl h-full overflow-hidden">
        <div className="p-10">
          {children}
        </div>
      </div>
    ...
    return (
      <>
        ...
        <div className="flex flex-col gap-4">
          ...
          />
          <Button 
            className="bg-orange-400 text-white hover:bg-orange-500 w-full"
