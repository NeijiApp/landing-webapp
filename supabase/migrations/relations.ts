...
export const meditationHistoryRelations = relations(
	meditationHistory,
	({ one, many }) => ({
...
export const meditationFavoritesRelations = relations(
	meditationFavorites,
	({ one }) => ({
		usersTable: one(usersTable, {
...
export const meditationAnalyticsRelations = relations(
	meditationAnalytics,
	({ one }) => ({
		meditationHistory: one(meditationHistory, {
